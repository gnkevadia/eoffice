<?php
/**
 * News Master Emailtemplate
 * Manage CRUD for the News
 *
 * @author ATL
 * @since Jan 2020
 */
...
class NewsController extends Controller
{
    ...
    {
        $this->objModel = new News;
        Common::defineDynamicConstant('news');
    }
    ...
    public function add(Request $request)
    {
        ...
        $arrFile = array('name'=>'media_file','type'=>'file','resize'=>'16','path'=>'images/news/', 'predefine'=>'', 'except'=>'file_exist');
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if (isset($data) && !empty($data)) {
            ...
            $arrFile = array('name'=>'media_file','type'=>'file','resize'=>'16','path'=>'images/news/', 'predefine'=>'', 'except'=>'file_exist', 'existing'=>$data->media_file);
