...
class CountryLanguage extends Model
{
    ...
    */
    ...
    {
        return CountryLanguage::where(['id' => $id])->first();
    }
    ...
    */
    ...
    {
        return CountryLanguage::whereIn('id', explode(',', $ids))->update($arrUpdate);
    }
    ...
    */
    ...
    {
        return CountryLanguage::where('id', $id)->update($arrUpdate);
    }
    ...
    */
    public function getCountByCriteria($id = null, $criteria, $menuTypeId=null)
    {
        if ($id != null) {
            ...
            return CountryLanguage::where($criteria)->where('id', '<>', $id)->count();
        } else {
            return CountryLanguage::where($criteria)->count();
        }
    }
    ...
    */
    ...
    {
        return CountryLanguage::where(['deleted' => 0])
    ...
    */
    ...
    {
        return CountryLanguage::leftJoin('rights', 'rights.module_id', '=', 'modules.id')
