...
class Currency extends Model
{
    ...
    */
    ...
    {
        return Currency::whereIn('id', explode(',', $ids))->update($arrUpdate);
    }
    ...
    */
    ...
    {
        return Currency::where('id', $id)->update($arrUpdate);
    }
    ...
    */
    public function getCountByCriteria($id = null, $criteria, $menuTypeId=null)
    {
        if ($id != null) {
            ...
            return Currency::where($criteria)->where('id', '<>', $id)->count();
        } else {
            return Currency::where($criteria)->count();
        }
    }
    ...
    */
    ...
    {
        return Currency::where(['deleted' => 0])
    ...
    */
    ...
    {
        return Currency::leftJoin('rights', 'rights.module_id', '=', 'modules.id')
