...
class Coupon extends Model
{
    ...
    */
    ...
    {
        return Coupon::whereIn('id', explode(',', $ids))->update($arrUpdate);
    }
    ...
    */
    ...
    {
        return Coupon::where('id', $id)->update($arrUpdate);
    }
    ...
    */
    ...
    {
        if ($id != null) {
            return Coupon::where($criteria)->where('id', '<>', $id)->count();
        } else {
            return Coupon::where($criteria)->count();
        }
    }
