...
/**
 * request_demo Model
 * Manage CRUD for the request_demo
 *
 * @author ATL
 * @since Jan 2020
*/
...
class RequestDemo extends Model
{
    ...
    */
    ...
    {
        return request_demo::where(['id' => $id])->first();
    }
    ...
    */
    ...
    {
        return request_demo::whereIn('id', explode(',', $ids))->update($arrUpdate);
    }
    ...
    */
    ...
    {
        return request_demo::where('id', $id)->update($arrUpdate);
    }
    ...
    */
    ...
    {
        if ($id != null) {
            return request_demo::where($criteria)->where('id', '<>', $id)->count();
        } else {
            return request_demo::where($criteria)->count();
        }
    }
    ...
    */
    ...
    {
        return request_demo::where(['deleted' => 0])
