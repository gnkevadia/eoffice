...
class Banner extends Model
{
    ...
    */
    ...
    {
        return Banner::whereIn('id', explode(',', $ids))->update($arrUpdate);
    }
    ...
    */
    ...
    {
        return Banner::where('id', $id)->update($arrUpdate);
    }
    ...
    */
    ...
    {
        if ($id != null) {
            return Banner::where($criteria)->where('id', '<>', $id)->count();
        } else {
            return Banner::where($criteria)->count();
        }
    }
