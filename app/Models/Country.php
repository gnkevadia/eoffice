...
class Country extends Model
{
    ...
    */
    ...
    {
        return Country::whereIn('id', explode(',', $ids))->update($arrUpdate);
    }
    ...
    */
    ...
    {
        return Country::where('id', $id)->update($arrUpdate);
    }
    ...
    */
    public function getCountByCriteria($id = null, $criteria, $menuTypeId=null)
    {
        if ($id != null) {
            ...
            return Country::where($criteria)->where('id', '<>', $id)->count();
        } else {
            return Country::where($criteria)->count();
        }
    }
    ...
    */
    ...
    {
        return Country::where(['deleted' => 0])
    ...
    */
    ...
    {
        return Country::leftJoin('rights', 'rights.module_id', '=', 'modules.id')
