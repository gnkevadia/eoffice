<?php
	...
	if ($SelectLeads->num_rows > 0) 
	{
		...
		while($row = $SelectLeads->fetch_assoc()) {
			...
			$sender = 'WSANTA';
			$message = nl2br("Hi ".$row["name"].", Thank you for registering with Fuel Trend. Surprise your child this Christmas. Book trained, authentic Santas and elves for a home visit or a Christmas party for a magical Christmas experience. To know more visit www.FuelTrend.com");
