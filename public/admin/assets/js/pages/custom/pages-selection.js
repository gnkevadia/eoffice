						...
						},
						{
							...
							template: function(row) {
								...
								if(isViewStatus == true){
									roleBasedAction += '<a href="'+viewURL+'/'+row.page_id+'" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit details"><i class="flaticon-eye"></i></a>'
								}
								if(isUpdateStatus == true){
									roleBasedAction += '<a href="'+editURL+'/'+row.page_id+'" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit details"><i class="la la-edit"></i></a>'
								}
								if(isDeleteStatus == true){
									roleBasedAction += '<a href="javascript:;" data-toggle="modal" data-target="#delete_modules" data-id="'+row.page_id+'"  class="btn btn-sm btn-clean btn-icon btn-icon-md delete_row" title="Edit details"><i class="flaticon-delete"></i></a>'
								}
