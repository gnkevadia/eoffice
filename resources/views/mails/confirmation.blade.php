...
<html style="margin: 0;">
   ...
   <body style="margin: 0;">
            ...
            <tr>
               <td>
                  <table width="710px" border="0" cellspacing="0" cellpadding="0">
                     <tbody>
                        <tr>
                           <td><img style="display: block;width: 794px; height: 400px;" src="http://www.FuelTrend.com/mailers/confirmation-mailer/confirmation-pdf-header.jpg"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           <td bgcolor="#d8382c">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tbody>
                                    <tr>
                                       <td width="50%" style="padding-left: 105px;"><img src="http://www.FuelTrend.com/mailers/confirmation-mailer/booking-summary.jpg"></td>
                                    ...
                                    <td style="padding:8px; font-size:14px; font-family:'arial', sans-serif;">
                                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          ...
                                          <tr>
                                             ...
                                             <td style="padding:5px; font-size:14px; font-family:'arial', sans-serif;">Date: {{date('dS M Y',strtotime($orderDetails->booking_date))}}  |  Time Slot: {{str_replace('Noon','Afternoon',ucfirst($orderDetails->package_time))}}</td>
                                          </tr>
                                          <tr>
                                             <td style="padding:5px; font-size:14px; font-family:'arial', sans-serif;">Package: {{$orderDetails->package}}</td>
                                             <td style="padding:5px; font-size:14px; font-family:'arial', sans-serif;">Area: {{$orderDetails->area}}, {{$orderDetails->city}}</td>
                                          </tr>
                                          <tr>
                                             <td style="padding:5px; font-size:14px; font-family:'arial', sans-serif;">Noumber of Kids: {{$orderDetails->kids}}</td>
                                             <td style="padding:5px; font-size:14px; font-family:'arial', sans-serif;">Booking Date: {{date('dS M Y',strtotime($orderDetails->created_at))}}</td>
                                          </tr>
                                       </table>
                                    </td>
                                 </tr>
                                 ...
                                 <tr>
                                    <td style="padding:8px; font-size:14px; font-family:'arial', sans-serif;">
                                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          ...
                                          <tr>
                                             <td style="padding:5px; font-size:14px; font-family:'arial', sans-serif;">Guardian Name: {{$orderDetails->guardian_name}}</td>
                                             <td style="padding:5px; font-size:14px; font-family:'arial', sans-serif;">Email id: {{$orderDetails->guardian_email}}</td>
                                          </tr>
                                          <tr>
                                             <td style="padding:5px; font-size:14px; font-family:'arial', sans-serif;">Mobile No.: {{$orderDetails->guardian_mobile}}</td>
                                             <td style="padding:5px; font-size:14px; font-family:'arial', sans-serif;">Alternate No.: {{$orderDetails->guardian_alt_mobile}}</td>
                                          </tr>
                                          <tr>
                                             <td colspan="2" style="padding:5px; font-size:14px; font-family:'arial', sans-serif;">Address: {{$orderDetails->guardian_address}}</td>
                                          </tr>
                                       </table>
                                    </td>
                                 </tr>
                                          ...
                                          <tr>
                                             <td width="50%" style="padding:5px; font-size:14px; font-family:'arial', sans-serif; border-right:1px solid #000000;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                   ...
                                                   <tr>
                                                      <td style="padding:5px; font-size:14px; font-family:'arial', sans-serif;">Kid's Name: {{ $kidDetails->kidname[$key] }}      Kid's Age: {{ $kidDetails->kidage[$key].' Years' }}       Gender: {{ $kidDetails->kidgender[$key] }}</td>
                                                   </tr>
                                                   @endforeach  
                                                </table>
                                             </td>
                              ...
                              <table style="text-align:left; background-color:#D9DADA; border-radius: 10px; padding-left:5px; width:100%;" width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td style="padding:8px; font-size:14px; font-family:'arial', sans-serif;">
                                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                             <td width="50%" style="padding:8px; font-weight:bold; font-size:14px; font-family:'arial', sans-serif;">Gift & Special Message</td>
                                          </tr>
                                          <tr>
                                             <td style="padding:5px; font-size:14px; font-family:'arial', sans-serif;">
                              ...
                              <table style="text-align:left; background-color:#D9DADA; border-radius: 10px; padding-left:5px; width:100%;" width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td style="padding:8px; font-size:14px; font-family:'arial', sans-serif;">
                                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                             <td width="50%" style="padding:8px; font-weight:bold; font-size:14px; font-family:'arial', sans-serif;">Total amount paid: Rs. ₹ {{ $orderDetails->totalpriceamt }}</td>
                                          </tr>
                                       </table>
                                    </td>
                                 </tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
         <tbody>
            <tr>
               <td style="padding:20px 40px; font-weight:bold; font-size:11px; font-family:'arial', sans-serif;  word-break:break-all; word-wrap:break-word;">
            ...
            <tr>
               <td style="padding:0px 40px;"><img  style="display: block; width:640px;" src="http://www.FuelTrend.com/mailers/confirmation-mailer/logos.jpg"/></td>
            </tr>
            <tr>
               <td>&nbsp;</td>
            </tr>
            ...
            <tr>
               <td><img width="100%" style="display: block; width:794px;" src="http://www.FuelTrend.com/mailers/confirmation-mailer/confirmation-pdf-footer.jpg"></td>
            </tr>
         </tbody>
      </table>
   </body>
