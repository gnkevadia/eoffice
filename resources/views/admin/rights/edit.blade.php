                        ...
                        <form id="frmAddEdit" name="frmAddEdit" action="{{ url(VIEW_INFO['url'].'/edit/'.$data->id) }}" class="form-horizontal" method="post">
                            ...
                            <div class="kt-portlet__body">
                                    ...
                                    <option value="">-Select-</option>
                                        @if(isset($arrModules) && !empty($arrModules))
                                            @foreach($arrModules as $key=>$val)
                                                <option value="{{ $val->id }}" @if(isset($data['module_id']) && $val->id == $data['module_id']) selected @endif >{{ $val->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                     ...
                                     <input type="text" id="routes" name="routes" data-toggle="tooltip" title="Enter Route" class="form-control" placeholder="Enter Route" value="{{ $data->routes }}">
