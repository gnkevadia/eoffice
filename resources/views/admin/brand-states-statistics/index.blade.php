        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            <div class="alert alert-light alert-elevate" role="alert">
                ...
                <div class="alert-text">
                    The {{ VIEW_INFO['title'] }} is useful to define {{ VIEW_INFO['title'] }} available in the application
                    which is managed by SA.
                </div>
            </div>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="dropdown dropdown-inline">
                                ...
                                <button type="button" class="btn btn-brand btn-icon-sm" _data-toggle="dropdown"><a href="{{ url('admin/brand-states-statistics/import') }}" class="kt-nav__link" style="color:#ffffff"><i class="icon-2x text-dark-50 flaticon-upload"></i>Imports</a></button>
                             </div>
                        </div>
                    </div>
                </div>
...
@stop
@section('metronic_js')
    <script src="{{ asset('admin/assets/js/pages/custom/brand-states-statistics-selection.js') }}" type="text/javascript">
    </script>
@stop
