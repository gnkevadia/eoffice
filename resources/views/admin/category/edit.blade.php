...
<div class="kt-subheader__breadcrumbs">
    ...
    <a href="{{ url('admin/category') }}" class="kt-subheader__breadcrumbs-link">{{VIEW_INFO['title']}}</a>
    <span class="kt-subheader__breadcrumbs-separator"></span>
                        ...
                        <input type="hidden" name="id" id="id" value="{{ $data->id }}">
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="ordering" name="ordering" data-toggle="tooltip" title="Enter Ordering" class="form-control" placeholder="Enter Ordering" value="{{ $data->ordering }}" />
                                </div>

                                <div class="form-group">
                                <label>URL</label>
                                <textarea id="description" name="description" rows="2" cols="5" data-toggle="tooltip" title="Enter Category Description"
                                class="form-control" placeholder="Enter Category Description">{{ $data->description }}</textarea>
                            </div>
