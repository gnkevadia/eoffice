...
<div class="kt-subheader__breadcrumbs">
    ...
    <a href="{{ url('admin/settingtype') }}" class="kt-subheader__breadcrumbs-link">{{VIEW_INFO['title']}}</a>
    <span class="kt-subheader__breadcrumbs-separator"></span>
    ...
    <div class="col-xs-12">
        <div class="box box-warning">
            <div class="box-header">
                <h3 class="box-title">Add {{ VIEW_INFO['title'] }}</h3>
            ...
            <!-- <div class="box-body">
                <form id="frmAddEdit" name="frmAddEdit" action="{{ url(VIEW_INFO['url'].'/add') }}" class="form-horizontal"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-md-3">Status<span class="required">*</span></label>
                                <div class="col-md-9">
                                    <select class="form-control" id="status" name="status">
                                        <option value="1" selected>Active</option>
                                        <option value="0">Inactive</option>
                    ...
                    <div class="row">
                        <div class="container-fluid">
                            <div class="col-sm-12 text-center">
                                ...
                                <a href="{{ url(VIEW_INFO['url']) }}"><button type="button" class="btn btn-warning"
...
@section('metronic_js')
<script src="{{ asset('admin/assets/js/pages/custom/settingtype.js') }}"></script>
@stop