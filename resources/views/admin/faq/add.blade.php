...
<div class="kt-subheader__breadcrumbs">
    ...
    <a href="{{ url('admin/faq') }}" class="kt-subheader__breadcrumbs-link">{{VIEW_INFO['title']}}</a>
    <span class="kt-subheader__breadcrumbs-separator"></span>
                    ...
                    method="post">{{ csrf_field() }}
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group">
                                    <label>Question<span class="required"><code>*</code></span></label>
                                    <input type="text" id="question" name="question" data-toggle="tooltip" title="Enter Question"
                                        class="form-control" placeholder="Enter Question" value="{{ old('question') }}" />
                                </div>
                                <div class="form-group">
                                        <label>Answer<span class="required"><code>*</code></span></label>
                                        <textarea id="answer" name="answer" rows="3" cols="5" data-toggle="tooltip" title="Enter Answer"
                                        class="form-control" placeholder="Enter Answer">{{ old('answer') }}</textarea>
                                    </div>
                                    <div class="form-group">
...
@section('metronic_js')
<script src="{{ asset('admin/assets/js/pages/custom/faq.js') }}"></script>
@stop