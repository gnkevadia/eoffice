                        ...
                        <form id="frmAddEdit" name="frmAddEdit" action="{{ url(VIEW_INFO['url'].'/edit/'.$data->id) }}" class="form-horizontal" method="post">
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="question" name="question" data-toggle="tooltip" title="Enter Question" class="form-control" placeholder="Enter Question" value="{{ $data->question }}">
                                </div>
                                <div class="form-group">
                                    <label>Answer<span class="required">*</span></label>
                                    <textarea id="answer" name="answer" data-toggle="tooltip" title="Enter Answer" class="form-control" placeholder="Enter Answer">{{ $data->answer }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Ordering</label>
                                    <input type="text" id="ordering" name="ordering" data-toggle="tooltip" title="Enter Ordering"
                                        class="form-control" placeholder="Enter Ordering" value="{{ $data->ordering }}" />
                                </div>
                                <div class="form-group">
