        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="kt-portlet">
                    ...
                    <form id="edit-states-form" name="edit-states-form"
                        action="{{ url(VIEW_INFO['url'] . '/edit/' . $data['id']) }}" class="" method="post">
                        {{ csrf_field() }}
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" maxlength="50"
                                            data-toggle="tooltip" title="Enter Name" class="form-control"
                                            placeholder="Enter Name" value="{{ $data['name'] }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label>
                                        <select name="status" id="status" class="form-control">
                                            <option {{ $data['status'] == 'Active' ? 'selected' : '' }} value="1">
                                                Active</option>
                                            <option {{ $data['status'] == 'Inactive' ? 'selected' : '' }} value="0">
                                                Inactive</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="border-top">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ url('/admin/brand') }}"><button type="button" class="btn btn-danger"
...
@section('metronic_js')
    <script src="{{ asset('admin/assets/js/pages/custom/brand.js') }}"></script>
@stop
