...
<form method="post" name="frmBookingX" id="frmBookingX">
        ...
        <div class="row">
            <div class="col-md-12">
            <input type="hidden" name="city_date_package" value="{{$getBookingDetails->city_date_package}}_{{$getBookingDetails->package_plan}}" id="city_date_package">
            <input type="hidden" id="adddiscountedamt" name="adddiscountedamt" value="">
            <input type="hidden" id="basepriceamt" name="basepriceamt" value="{{$getBookingDetails->basepriceamt}}">
            <input type="hidden" id="kids_start_from" name="kids_start_from" value="{{$getBookingDetails->kids_start_from}}">
            <input type="hidden" id="package_date" name="package_date" value="{{$getBookingDetails->booking_date}}">
            <input type="hidden" id="package_time" name="package_time" value="{{$getBookingDetails->package_time}}">
            <input type="hidden" id="choosedgift1" name="choosedgift1" value="{{$getBookingDetails->choosedgift1}}">
            <input type="hidden" id="choosedgift2" name="choosedgift2" value="{{$getBookingDetails->choosedgift2}}">
            <input type="hidden" id="addamt" name="addamt" value="">
            <input type="hidden" id="bookingId" name="bookingId" value="{{$getBookingDetails->id}}">
                <!--begin::Portlet-->
                                ...
                                <div class="accordion" id="">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        <label>City</label>
                                                                        <select onchange="changeoncity()" class="custom-select" name="city_id" id="city_id" required="true">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" value="{{$getBookingDetails->guardian_name}}" name="guardian_name" id="guardian_name" id="" class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Alternate Number</label>
                                                                        <input type="text" value="{{$getBookingDetails->guardian_alt_mobile}}" maxLength="10" name="guardian_alt_mobile" id="guardian_alt_mobile" id="" class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Address</label>
                                                                        <textarea type="text" name="guardian_address" id="guardian_address" class="form-control" >{{$getBookingDetails->guardian_address}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        <label>Mobile</label>
                                                                        <input type="text" value="{{$getBookingDetails->guardian_mobile}}" maxLength="10" name="guardian_mobile" id="guardian_mobile" class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Email</label>
                                                                        <input type="text" value="{{$getBookingDetails->guardian_email}}" name="guardian_email" id="guardian_email" class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" value="{{$getBookingDetails->bill_name}}" name="bill_name" id="bill_name" class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Alternate Number</label>
                                                                        <input type="text" value="{{$getBookingDetails->bill_alt_mobile}}" maxLength="10" name="bill_alt_mobile" id="bill_alt_mobile" class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Address</label>
                                                                        <textarea type="text" name="bill_address" id="bill_address" class="form-control">{{$getBookingDetails->bill_address}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        <label>Mobile</label>
                                                                        <input type="text" value="{{$getBookingDetails->bill_mobile}}" maxLength="10" name="bill_mobile" id="bill_mobile" class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Email</label>
                                                                        <input type="text" value="{{$getBookingDetails->bill_email}}" name="bill_email" id="bill_email" class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
													...
													<div id="collapseFour1" class="collapse show" aria-labelledby="headingFour1" data-parent="#accordionExample1">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        <input type="checkbox" @php echo ($getBookingDetails->choosedgift1) ? 'checked' : '' @endphp  name="choodegift" id="choodegift_hand" class="choodegift" value="gift" >
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea id="special_notes" name="special_instruction"  class="form-control">{{$getBookingDetails->special_instruction}} </textarea>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea  id="special_message" name="special_message" class="form-control">{{$getBookingDetails->special_message}}</textarea>                                                                        
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea id="special_notes" name="special_notes" class="form-control">{{$getBookingDetails->special_notes}} </textarea>           
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea id="admin_inclusion" name="admin_inclusion" class="form-control">{{$getBookingDetails->admin_inclusion}} </textarea>       
                                                                    </div>
                                                                </div>
                                                            </div>  
                                                        </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text"  value="{{$getBookingDetails->basepriceactulaamt}}" name="basepriceactulaamt" id="basepriceactulaamt" readonly class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text"  value="{{$getBookingDetails->discountamt}}" name="discountamt" id="discountamt" readonly class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text"  value="{{$getBookingDetails->discountedamt}}" name="discountedamt" id="discountedamt" readonly class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        <label>Tax</label>
                                                                        <input type="text"  value="{{$getBookingDetails->taxamt}}" name="taxamt" id="taxamt" readonly class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        <label>Coupon</label>
                                                                        <input type="text"  value="{{$getBookingDetails->coupon_code}}" name="coupon_code" id="coupon_code" class="form-control coupon_code">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-control addamountadmin">{{$getBookingDetails->addamt}}</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        <label>Total</label>
                                                                        <input type="text"  value="{{$getBookingDetails->totalpriceamt}}" name="totalpriceamt" readonly id="totalpriceamt" class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card">
                                                    <div class="row">
                                                        <div class="col-md-1">
                                                            <div class="card-body">
                                                            <input class="btn btn-success" type="submit" value="Update" name="Save" id="save_booking"/>
                                                            </div>
                                                        </div> 
                                                        <div class="col-md-1">
                                                            <div class="card-body">
...
$('document').ready(function() {
    $('#city_id').val('{{$getBookingDetails->city_id}}');    
    changeoncity() 
    $('#area_id').val('{{$getBookingDetails->area_id}}');    
})
function changeoncity() {    
    $('#area_id').find('option').hide()
    ...
    $.ajax({
        ...
        success: function( data, textStatus, jQxhr ){
            ...
            $('#package_id').val('{{$getBookingDetails->package_id}}');
...
$('#package_id').change(function(){
    $.ajax({
        ...
        success: function( data, textStatus, jQxhr ){
            ...
            $('#surprice_package_date').val('{{$getBookingDetails->booking_date}}');
            $('#surprice_package_date').trigger('change');
            $.ajax({
                url: '/admin/booking/add',        
                type: 'get',        
                ...
                success: function( data, textStatus, jQxhr ){
                    $('#kids').html(data);
                    $('#kids').val('{{$getBookingDetails->kids}}');
                    $('#kids').trigger('change')
                }
            });
        }
...
$('#surprice_package_date').change(function(){
    $.ajax({
        url: '/admin/booking/add',        
        type: 'get',        
        data: { 'getPackageDetails' : '1','booking_date': $('#surprice_package_date').val(),'package_id': $('#package_id').val(), 'city_id': $('#city_id').val(),'package_plan': '{{$getBookingDetails->package_plan}}','city_date_package': '{{$getBookingDetails->city_date_package}}' },
        success: function( data, textStatus, jQxhr ){
            $('#package_plan_div').html(data);
            $('#package_plan').val('{{$getBookingDetails->package_plan}}');            
        }
    });    
})
$(".copyAdrs").on("click",function () {
    ...
    $('#kids').on('change', function(slick) {
      $("#noofkidit").html('');
      @if(isset($getBookingDetails) && $getBookingDetails->kidname != '')
      var $availableKids=JSON.parse('{!! $getBookingDetails->kidname !!}');
      @else
      var $availableKids = '';
      @endif
      var cild;      
      if($("#kids").val() > 0){
         for(cild=1;cild<=$("#kids").val();cild++){
           if($availableKids) {
            $("#noofkidit").append('<div class="row"><div class="col-md-4"><div class="card-body"><div class="form-group"><input type="text" id="kidname_'+cild+'" name="kidname[]" class="kidname form-control" placeholder="Kids name goes here" value="'+(typeof $availableKids['kidname'][cild-1] !== "undefined" && $availableKids['kidname'][cild-1] !== null ? $availableKids['kidname'][cild-1] : '' )+'"></div></div></div><div class="col-md-4"><div class="card-body"><div class="form-group"><input value="'+(typeof $availableKids['kidage'][cild-1] !== "undefined" &&  $availableKids['kidage'][cild-1] !== null ? $availableKids['kidage'][cild-1] : '' )+'" type="text" placeholder="Age" id="kidage_'+(cild-1)+'" name="kidage[]" class="kidage number form-control" onkeypress="return isNumberKey(event)"></div></div></div><div class="col-md-4"><div class="card-body"><div class="form-group"><select name="kidgender[]" class="kidgender form-control" id="kidgender_'+cild+'"><option '+($availableKids['kidname'][cild-1] == 'Boy' && $availableKids['kidname'][cild-1] !== null ? 'selected="selected"' : '')+' value="Boy">Boy</option><option '+($availableKids['kidname'][cild-1] == 'Girl' ? 'selected="selected"' : '')+' value="Girl">Girl</option></select></div></div></div></div>');
           } else {
