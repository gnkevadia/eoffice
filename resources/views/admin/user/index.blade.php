...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							<div class="alert alert-light alert-elevate" role="alert">
								...
								<div class="alert-text">
									The {{VIEW_INFO['title']}} is useful to define modules available in the application which is managed by SA.
								</div>
							</div>
...
@stop
@section('metronic_js')
<script src="{{ asset('admin/assets/js/pages/custom/user-selection.js')}}" type="text/javascript"></script>
@stop