            ...
            <div class="col-md-12">
                ...
                <div class="kt-portlet">
                    ...
                    <form enctype="multipart/form-data" id="frmAddEdit" name="frmAddEdit"
                        action="{{ url(VIEW_INFO['url'] . '/add') }}" class="kt-form" method="post">
                        {{ csrf_field() }}
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="address1" name="address1" data-toggle="tooltip" title="Address1"
                                    class="form-control" placeholder="Address1" value="{{ old('address1') }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="address2" name="address2" data-toggle="tooltip" title="Address2"
                                    class="form-control" placeholder="Address2" value="{{ old('address2') }}">
                            </div>
                            <div class="form-group">
                                    ...
                                    <select name="role_id" id="role_id" class="form-control">
                                        ...
                                        @if (isset($arrRole) && !empty($arrRole))
                                            @foreach ($arrRole as $key => $val)
                                                <option value="{{ $val->id }}"
                                                    {{ old('role_id') == $val->id ? 'selected' : '' }}>{{ $val->name }}
                                                </option>
                                            @endforeach
                                        @endif
                                    </select>
