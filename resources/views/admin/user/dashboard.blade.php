            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
              <ul class="kt-nav">
                <li class="kt-nav__section kt-nav__section--first">
                  <span class="kt-nav__section-text">Role & Permission</span>
                </li>
                <li class="kt-nav__item">
                  <a href="{{ url('admin/user') }}" class="kt-nav__link">
                    <i class="kt-nav__link-icon flaticon-users"></i>
                    <span class="kt-nav__link-text">Users</span>
                  </a>
                </li>
                <li class="kt-nav__item">
                  <a href="{{ url('admin/rights') }}" class="kt-nav__link">
                    <i class="kt-nav__link-icon flaticon-share"></i>
                    <span class="kt-nav__link-text">Rights</span>
                  </a>
                </li>
                <li class="kt-nav__item">
                  <a href="{{ url('admin/menu') }}" class="kt-nav__link">
                    <i class="kt-nav__link-icon flaticon-menu-button"></i>
                    <span class="kt-nav__link-text">Menus</span>
                  </a>
                </li>
                <li class="kt-nav__section">
                  <span class="kt-nav__section-text">Master</span>
                </li>
                <li class="kt-nav__item">
                  <a href="{{ url('admin/task') }}" class="kt-nav__link">
                    <i class="kt-nav__link-icon flaticon2-architecture-and-city"></i>
                    <span class="kt-nav__link-text">Task</span>
                  </a>
                </li>
                <li class="kt-nav__item">
                  <a href="{{ url('admin/project') }}" class="kt-nav__link">
                    <i class="kt-nav__link-icon flaticon2-document"></i>
                    <span class="kt-nav__link-text">Project</span>
                  </a>
                </li>
                @if(Session::get('superAdmin'))
                <li class="kt-nav__item">
                  <a href="{{ url('admin/task-status') }}" class="kt-nav__link">
                    <i class="kt-nav__link-icon flaticon2-layers-2"></i>
                    <span class="kt-nav__link-text">Task Status</span>
                  </a>
                </li>
                @endif
              </ul>
