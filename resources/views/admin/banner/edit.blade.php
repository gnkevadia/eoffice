                        ...
                        <form id="frmAddEdit" name="frmAddEdit" action="{{ url(VIEW_INFO['url'].'/edit/'.$data->id) }}" class="form-horizontal" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" data-toggle="tooltip" title="Enter Title" class="form-control" placeholder="Enter Title" value="{{ $data->name }}">
                                </div>
                                <div class="form-group">
                                    <label>Sub Title<span class="required"><code>*</code></span></label>
                                    <input type="text" id="sub_title" name="sub_title" data-toggle="tooltip" title="Enter Sub Title"
                                        class="form-control" placeholder="Enter Sub Title" value="{{ $data->sub_title }}" />
                                </div>
                                <div class="form-group">
                                    <label>Button Text</label>
                                    <input type="text" id="button" name="button" data-toggle="tooltip" title="Enter Sub Title"
                                        class="form-control" placeholder="Enter Sub Title" value="{{ $data->button }}" />
                                </div>
                                <div class="form-group">
...
@section('metronic_js')
<script src="{{ asset('admin/assets/js/pages/custom/banner.js') }}"></script>
@stop