                    ...
                    <form id="frmAddEdit" name="frmAddEdit" action="{{ url(VIEW_INFO['url'].'/edit/'.$data->id) }}" class="kt-form" method="post">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" maxlength="50" data-toggle="tooltip" title="Enter Name" class="form-control" placeholder="Enter Name" required value="{{ $data->name }}">
                            </div>

							<div class="form-group">
								<label>Icon<span class="required">*</span></label>
								<input type="text" id="icon" name="icon" data-toggle="tooltip" title="Enter Icon" class="form-control" placeholder="Enter Icon" value="{{ $data->icon }}">
							</div>
