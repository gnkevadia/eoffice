...
<div class="kt-subheader__breadcrumbs">
    ...
    <a href="{{ url('admin/pagetypes') }}" class="kt-subheader__breadcrumbs-link">{{VIEW_INFO['title']}}</a>
    <span class="kt-subheader__breadcrumbs-separator"></span>
                    ...
                    <form id="frmAddEdit" name="frmAddEdit" action="{{ url(VIEW_INFO['url'].'/add') }}" class="kt-form" method="post">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" maxlength="50" data-toggle="tooltip" title="Enter Name" class="form-control" placeholder="Enter Name" required @if(isset($data['name'])) value="{{ $data['name'] }}" @endif>
                            </div>

							<div class="form-group">
								<label>Icon<span class="required">*</span></label>
								<input type="text" id="icon" name="icon" data-toggle="tooltip" title="Enter Icon" class="form-control" placeholder="Enter Icon">
							</div>
...
@section('metronic_js')
<script src="{{ asset('admin/assets/js/pages/custom/pagetype.js') }}"></script>
@stop
