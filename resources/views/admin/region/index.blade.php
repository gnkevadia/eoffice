...
<div class="kt-subheader__breadcrumbs">
    ...
    <a href="{{ url('admin/region') }}" class="kt-subheader__breadcrumbs-link">{{VIEW_INFO['title']}}</a>
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							<div class="alert alert-light alert-elevate" role="alert">
								...
								<div class="alert-text">
									The Currency is useful to define Currency available in the application which is managed by SA.
								</div>
							</div>
...
@stop
@section('metronic_js')
<script src="{{ asset('admin/assets/js/pages/custom/region-selection.js')}}" type="text/javascript"></script>
@stop