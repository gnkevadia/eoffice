                ...
                <div class="kt-portlet">
                        ...
                        <form id="frmAddEdit" name="frmAddEdit" action="{{ url(VIEW_INFO['url'].'/edit/'.$data->id) }}" class="form-horizontal" method="post">
                            ...
                            <div class="kt-portlet__body">
                                    ...
                                    <div>
                                    <select name="email_Template_type_id" id="email_Template_type_id" class="form-control" disabled>
                                        <option value="">-Select Template Type-</option>
                                            @if(isset($arrSettingtype) && !empty($arrSettingtype))
                                                @foreach($arrSettingtype as $key=>$val)
                                                <option value="{{ $val->id }}" @if(isset($data['email_Template_type_id']) && $val->id == $data['email_Template_type_id']) selected @endif >{{ $val->name }}</option>
                                                @endforeach
                                            @endif
                                    </select>
                                    </div>
