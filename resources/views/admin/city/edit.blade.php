...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
		...
		<form id="frmAddEdit" name="frmAddEdit" action="{{ url('admin/city/edit/'.$data->id) }}" class="" method="post">{{ csrf_field() }}
                                                        ...
                                                        <div class='element cityrow' id='div_{{$keyCluster+2}}'>
                                                            <div class='row'>
                                                                ...
                                                                <div class='form-group col-md-2'>
                                                                    <button type='button' id='remove_{{$keyCluster+2}}' class='remove btn btn-danger float-right'><i title='Remove City' class='fa fa-trash'></i> Remove Cluster</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
