...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="kt-portlet kt-portlet--mobile">
								...
								<div class="kt-portlet__body">
                                        ...
                                        <!-- begin:: Aside -->
                                        @include('admin.layouts.cityfilteraction')
                                        <!-- end:: Aside Menu -->									
								    </div>
...
@include('admin.layouts.copy',['action_url' => VIEW_INFO['url'].'/copy'])

<!-- /.content -->
@stop
@section('metronic_js')
<script src="{{ asset('admin/assets/js/pages/custom/city-selection.js')}}" type="text/javascript"></script>
@stop