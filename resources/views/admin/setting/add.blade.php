                    ...
                    method="post">{{ csrf_field() }}
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                <select name="setting_type_id" id="setting_type_id" class="form-control" >
                                    <option value="">-Select Setting Type-</option>
                                        @if(isset($arrSettingtype) && !empty($arrSettingtype))
                                            @foreach($arrSettingtype as $key=>$val)
                                            <option value="{{ $val->id }}" {{ old('setting_type_id') == $val->id ? 'selected' : '' }} >{{ $val->name }}</option>
                                            @endforeach
                                        @endif
                                </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="value" name="value" data-toggle="tooltip" title="Enter Value" class="form-control" placeholder="Enter Value" value="{{ old('value') }}">
                            </div>
