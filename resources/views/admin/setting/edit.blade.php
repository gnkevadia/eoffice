...
<div class="kt-subheader__breadcrumbs">
    ...
    <a href="{{ url('admin/setting') }}" class="kt-subheader__breadcrumbs-link">{{VIEW_INFO['title']}}</a>
    <span class="kt-subheader__breadcrumbs-separator"></span>
                    ...
                    class="form-horizontal" method="post">{{ csrf_field() }}
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group">
                                    <label>Setting Type<span class="required"><code>*</code></span></label>
                                    <div>
                                    <select name="setting_type_id" id="setting_type_id" class="form-control" disabled>
                                        <option value="">-Select Setting Type-</option>
                                            @if(isset($arrSettingtype) && !empty($arrSettingtype))
                                                @foreach($arrSettingtype as $key=>$val)
                                                    <option value="{{ $val->id }}" @if(isset($data['setting_type_id']) && $val->id == $data['setting_type_id']) selected @endif >{{ $val->name }}</option>
                                                @endforeach
                                            @endif
                                    </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label>Value<span class="required"><code>*</code></span></label>
                                    <input type="text" id="value" name="value" data-toggle="tooltip" title="Enter Value" class="form-control" placeholder="Enter Value" value="{{ $data->value }}">
                                </div>
...
@section('metronic_js')
<script src="{{ asset('admin/assets/js/pages/custom/setting.js') }}"></script>
@stop