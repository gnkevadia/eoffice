                                    ...
                                    @include('admin.includes.errormessage')
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" id="star" name="star" data-toggle="tooltip" title="Enter Star" class="form-control" placeholder="Enter Sode" value="" min="1" max="5" />
                                            </div>
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" id="name" name="name" data-toggle="tooltip" title="Enter Name" class="form-control" placeholder="Enter Store Name" value="" />
                                            </div>
                                            <div class="form-group col-md-6">
                                                    <label>Company<span class="required"><code>*</code></span></label>
                                                    <input type="text" id="company" name="company" data-toggle="tooltip" title="Enter Company Name" class="form-control" placeholder="Enter Company Name" value="" />
                                            </div>
                                        </div>
