                        ...
                        <form id="frmAddEdit" name="frmAddEdit" action="{{ url(VIEW_INFO['url'].'/edit/'.$data->id) }}" class="form-horizontal" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group">
                                    <label>USP<span class="required">*</span></label>
                                    <input type="text" id="name" name="name" data-toggle="tooltip" title="Enter USP" class="form-control" placeholder="Enter USP" value="{{ $data->name }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="kt-widget__media">
                                        <input type="hidden" id="image_exist" name="image_exist" value="{{$data->img}}">
                                        <img src="{{url($arrFile['path'].$arrFile['resize'].'x'.$arrFile['resize'].'/'.$data->img)}}" alt="image">
                                    </div>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="order" name="order" data-toggle="tooltip" title="Enter Order"
                                        class="form-control" placeholder="Enter Order" value="{{ $data->order }}" />
                                </div>
                                <div class="form-group">
