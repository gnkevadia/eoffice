...
<div class="kt-subheader__breadcrumbs">
    ...
    <a href="{{ url('admin/email-template-types') }}" class="kt-subheader__breadcrumbs-link">{{VIEW_INFO['title']}}</a>
...
@stop
@section('metronic_js')
<script src="{{ asset('admin/assets/js/pages/custom/email-template-type-selection.js')}}" type="text/javascript"></script>
@stop