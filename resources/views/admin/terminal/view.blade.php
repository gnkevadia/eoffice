...
<div class="kt-subheader__breadcrumbs">
    ...
    <span class="kt-subheader__breadcrumbs-separator"></span>
    <a href="#" class="kt-subheader__breadcrumbs-link">View {{ucwords(str_replace("-"," ", VIEW_INFO['title']))}} Details</a>
                        ...
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                        View {{ucwords(str_replace("-"," ", VIEW_INFO['title']))}}
                                </h3>
                            </div>
                        </div>
                        <!--begin::Form-->
...
<script src="{{ asset('admin/assets/js/pages/custom/team-member-role.js') }}"></script>
<script>
