                ...
                <form enctype="multipart/form-data" id="frmAddEdit" name="frmAddEdit" action="{{ url(VIEW_INFO['url'].'/edit/'.$data->id) }}" class="kt-form" method="post">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group">
                            <label>Task Status Name<span class="required">*</span></label>
                            <input type="text" id="task_status" name="name" data-toggle="tooltip" title="Enter Task Status Name" class="form-control" placeholder="Enter Task Status Name" value="{{$data->name}}">
                        </div>
...
@section('metronic_js')
<script src="{{ asset('admin/assets/js/pages/custom/task-status-validation.js') }}"></script>
@stop