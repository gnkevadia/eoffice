                ...
                <form enctype="multipart/form-data" id="frmAddEdit" name="frmAddEdit" action="{{ url(VIEW_INFO['url'].'/add') }}" class="kt-form" method="post">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="task_status" name="name" data-toggle="tooltip" title="Enter Task Status Name" class="form-control" placeholder="Enter Task Status Name" value="{{ old('name') }}">
                        </div>
